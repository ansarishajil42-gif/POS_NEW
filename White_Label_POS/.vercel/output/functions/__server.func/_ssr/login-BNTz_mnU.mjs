...
import { c as resetCashierPinSelfFn, i as getTenantsAndBranchesFn, n as getBranchCashiersAndTillsFn } from "./auth-server-DvbM03n9.mjs";
import { n as useAuth } from "./auth-C7cLdC_r.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/login-BNTz_mnU.js
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Label, {
									...
									children: [
										...
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
											...
											className: "absolute right-3.5 top-1/2 -translate-y-1/2 text-muted-foreground hover:text-ink transition-colors",
											children: showPin ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(EyeOff, { className: "h-5 w-5" }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Eye, { className: "h-5 w-5" })
										})
									]
								})]
							}),
