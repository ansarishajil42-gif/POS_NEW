...
import { A as tenantSettings, E as staffUsers, L as createServerRpc, h as platformSettings, i as branches, j as tenants, m as orders, n as auditLogs, t as db } from "./db-CvXguwya.mjs";
import { t as logAuditAction } from "./audit-logger-DHg7DkYZ.mjs";
import { t as createBranchInternal } from "./branch-server-helpers-PrRF7Hfi.mjs";
import * as argon2 from "argon2";
//#region node_modules/.nitro/vite/services/ssr/assets/super-admin-server-BMGKws3Y.js
...
var updateTenantLimitsServerFn = createServerFn({ method: "POST" }).validator((d) => d).handler(updateTenantLimitsServerFn_createServerFn_handler, async ({ data }) => {
	...
	try {
		return await db.transaction(async (tx) => {
			...
			const { tills } = await import("./db-CvXguwya.mjs").then((n) => n.w);
