...
var deleteStaffFn = createServerFn({ method: "POST" }).validator((d) => d).handler(createSsrRpc("ea56662db705471e314aaef937b941b9313921db6dcbba41a81c0f8e24923ba1"));
...
//#endregion
export { updateCustomerFn as $, adjustCustomerBalanceFn as A, recordGRNServerFn as At, createVendorFn as B, Route$7 as C, createVendorInvoiceServerFn as Ct, Route$8 as D, getGrnDetailsServerFn as Dt, stockTransferServerFn as E, deleteVendorServerFn as Et, createBranchForTenantFn as F, deleteVendorFn as G, deactivatePromotionFn as H, createCustomerFn as I, handleOverrideRequestFn as J, getCustomerDetailsFn as K, createProductFn as L, applyClearanceFn$1 as M, submitPurchaseOrderServerFn as Mt, archivePromotionFn as N, updatePurchaseOrderServerFn as Nt, activateBranchFn as O, getInvoiceDetailsServerFn as Ot, createBatchServerFn as P, updateVendorServerFn as Pt, updateBranchFn as Q, createPromotionFn as R, searchPosCustomersFn as S, createPurchaseOrderServerFn as St, getInventoryLedgerFn as T, deletePurchaseOrderServerFn as Tt, deleteProductFn as U, deactivateBranchFn as V, deleteStaffFn as W, searchCustomersFn as X, listPromotionsFn as Y, toggleRolePermissionFn as Z, checkoutServerFn as _, getTenantAdminServerFn as _t, adjustStockFn as a, updateStockFn as at, openShiftServerFn as b, updateTenantStatusServerFn as bt, createRosterShiftFn as c, archiveTenantServerFn as ct, exportZReportFn as d, createTenantServerFn as dt, updateLoyaltySettingsFn as et, getStockAdjustmentHistoryFn as f, deleteBranchServerFn as ft, Route$5 as g, getBranchesServerFn as gt, Route$3 as h, getAuditLogsServerFn as ht, Route$2 as i, updateStaffFn as it, adjustCustomerPointsFn as j, recordVendorPaymentServerFn as jt, activatePromotionFn as k, getPODetailsServerFn as kt, createTillFn as l, createBranchServerFn as lt, resetCashierPinByManagerFn as m, downgradeTenantPlanServerFn as mt, Route as n, updateProductFn as nt, closeShiftFn as o, updateVatSettingsFn as ot, recordCashDropFn as p, deleteTenantAdminServerFn as pt, getCustomerPurchaseHistoryFn as q, Route$1 as r, updatePromotionFn as rt, createOverrideRequestFn as s, updateVendorFn as st, router_exports as t, updatePriceOverrideFn as tt, deleteRosterShiftFn as u, createExistingTenantAdminServerFn as ut, closeShiftServerFn as v, updatePlatformSettingsServerFn as vt, draftPurchaseOrderServerFn as w, createVendorServerFn as wt, recordCashDropServerFn as x, upgradeTenantPlanServerFn as xt, generateShiftReportFn as y, updateTenantAdminServerFn as yt, createStaffFn as z };
